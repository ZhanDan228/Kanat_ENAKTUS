<div class="user-con-grouped">
	<div class="user-con-content darkmode-txt">
		<div class="user-con-avatar">
			<div class='user-img-avatar' style="background: url('/img/firstBeneficiar.png') no-repeat center; background-size: cover;">
				<div class="">
					<div class='' style="background: url('/img/graphics/flags/spain.png') no-repeat center; background-size: cover;">
					</div>
				</div>
			</div>
		</div>
...
<!-- --------------------------------------- -->
	...
	<div class="user-con-content darkmode-txt">
		<div class="user-con-avatar">
			<div class='user-img-avatar' style="background: url('/img/secondBeneficiar.png') no-repeat center; background-size: cover;">
				<div class="">
					<div class='' style="background: url('/img/graphics/flags/estonia.png') no-repeat center; background-size: cover;">
					</div>
				</div>
			</div>
		</div>
...
<!-- <div class="user-con-content darkmode-txt">
	<div class="user-con-avatar">
		<div class='user-img-avatar' style="background: url('/img/users/ssshadow.png') no-repeat center; background-size: cover;">
			<div class="">
				<div class='' style="background: url('/img/graphics/flags/sweden.png') no-repeat center; background-size: cover;">
				</div>
			</div>
		</div>
	</div>
