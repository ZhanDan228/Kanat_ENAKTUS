	...
	<div class="user-con-content darkmode-txt">
		...
		<div class="user-con-wrapper">
			...
			<div class='user-tx3-content darkmode-txt'>
				<span>
				Daniel, программист, присоединился к нашей команде на поздних этапах проекта, принося с собой ценные навыки и знания в области программирования, которые помогли улучшить процессы переработки пищевых отходов в корм для животных. </span>
			</div>
